...
![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.1.jpg)
...
![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.2.jpg)

3. Создаем ключ SSH по алгоритму rsa с ключём размером 4096 бит.

![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.3.jpg)

4. Скопировав из локальной консоли ключ в буфер обмена вставляем ключ в появившееся на сайте поле с помощью команды
 cat ~/.ssh/id_rsa.pub | xclip -sel clip.

5. Создаем ключи pgp. Генерируем ключ.

![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.4.jpg)

6. Выводим список ключей и копируем отпечаток приватного ключа.

![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.5.jpg)

7. Копируем сгенерированный PGP ключ в буфер обмена. Вставляем ключ.Так же вставляем SSH ключ.

![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.6.jpg)

8. Используя введёный email, указываем Git применять его при подписи коммитов.

![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.7.jpg)

9. Создаем шаблон рабочего пространства. Для 2021–2022 учебного года и предмета «Операционные системы» (код
предмета os-intro) созданием репозиторий. Переходим в каталог курса. Удаляем лишние файлы. Удалите лишние файлы.Отправляем файлы на сервер.

![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.8.jpg)
![](file:///afs/.dk.sci.pfu.edu.ru/home/a/y/ayyavkina/1.9.jpg)

*Вывод:*
Я научилась оформлять файлы в MarkDown.
